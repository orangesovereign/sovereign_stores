/* =====================================================================
   SOVEREIGN STORES · STOREFRONT VIEW (docs/04 screen 1)
   Extracted from App when the Bureau joined. Behavior unchanged.
   ===================================================================== */

import { useMemo, useRef, useState } from 'react'
import { post, itemImage } from '../nui.js'
import { CategoryIcon, IconBasket } from './Icons.jsx'
...
export function ItemArt({ item, label, size }) {
...
export default function Storefront({ view, setView }) {
