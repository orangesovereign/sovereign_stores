...
NPCStores.medical = {
    ...
    buy = {
        ...
        { item = 'field_kit',  price = 15.00, category = 'meds' },
        { item = 'antipoison', price = 15.00, category = 'meds' },
        { item = 'cleanser',   price = 7.50,  category = 'meds' },
        { item = 'salve',      price = 10.00, category = 'meds' },
        { item = 'splint',     price = 20.00, category = 'meds' },
    },
